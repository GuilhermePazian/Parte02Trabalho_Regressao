...
\begin{itemize}
\item $Y_i$ - i-ésima observação da variável expvida  
\item $x_{1i}$ - i-esima observação da variável percap  
\item $x_{2i}$ - i-esima observação da variável analf  
\item $x_{3i}$ - i-esima observação da variável crime  
\item $x_{4i}$ - i-esima observação da variável estud  
\item $x_{5i}$ - i-esima observação da variável ndias  
\item $x_{6i}$ - i-esima observação da variável dens  
\end{itemize}
\vspace{0.5cm}
...
```{r residuos,fig.align='center',fig.height=5,fig.width=6, cache = FALSE,echo=FALSE, warning = FALSE,eval=TRUE,message = FALSE}
#echo = FALSE não permite que o chunk apareça no pdf
...
```{r envelope,cache = FALSE,echo=FALSE,fig.align='center',fig.height=4,fig.width=6.5, warning = FALSE,eval=TRUE,message = FALSE}
#echo = FALSE não permite que o chunk apareça no pdf
...
```{r residuos modelo otimo,cache = FALSE,echo=FALSE, fig.align='center',fig.width=6,fig.height=5,warning = FALSE,eval=TRUE,message = FALSE}
#echo = FALSE não permite que o chunk apareça no pdf
...
```{r envelope modelo otimo,cache = FALSE,fig.height=4,fig.width=6.5,echo=FALSE, warning = FALSE,eval=TRUE,message = FALSE}
#echo = FALSE não permite que o chunk apareça no pdf
...
library(ggplot2)
lb <- colnames(correlacao)
variaveis<-c(seq(1:4))
#plot(seqx,correlacao[1,])

#crime
corcrime=data.frame(correlacao[1,],variaveis)
colnames(corcrime)<-c("Crime","variaveis")
#
corestud=data.frame(correlacao[2,],variaveis)
colnames(corestud)<-c("Estud","variaveis")
#
corndias=data.frame(correlacao[3,],variaveis)
colnames(corndias)<-c("ndias","variaveis")
#
cordens=data.frame(correlacao[4,],variaveis)
colnames(cordens)<-c("dens","variaveis")

p1 <-ggplot(data=corcrime,aes(x=variaveis,y=Crime))+geom_point()+theme_light() + scale_x_discrete(limits=lb)

p2 <-ggplot(data=corestud,aes(x=variaveis,y=Estud))+geom_point()+theme_light()+ scale_x_discrete(limits=lb)

p3<-ggplot(data=corndias,aes(x=variaveis,y=ndias))+geom_point()+theme_light()+ scale_x_discrete(limits=lb)

p4 <- ggplot(data=cordens,aes(x=variaveis,y=dens))+geom_point()+theme_light()+ scale_x_discrete(limits=lb)
...
```{r alavancagem,fig.align='center',fig.height=4.5,fig.width=6.5,cache = FALSE,echo=FALSE, warning = FALSE,eval=TRUE,message = FALSE}
#echo = FALSE não permite que o chunk apareça no pdf
...
\vspace{0.5cm}
```{r residuos modelo otimo ajustado 1,fig.align='center',fig.height=4.5,fig.width=6.5,cache = FALSE,echo=FALSE, warning = FALSE,eval=TRUE,message = FALSE}
#echo = FALSE não permite que o chunk apareça no pdf
...
```{r envelope modelo otimo ajustado 1,fig.align='center',fig.height=4.5,fig.width=6.5,cache = FALSE,echo=FALSE, warning = FALSE,eval=TRUE,message = FALSE}
#echo = FALSE não permite que o chunk apareça no pdf
...
\vspace{1cm}
```{r residuos modelo otimo ajustado 2,fig.align='center',fig.height=4.5,fig.width=6.5,cache = FALSE,echo=FALSE, warning = FALSE,eval=TRUE,message = FALSE}
#echo = FALSE não permite que o chunk apareça no pdf
...
```{r envelope modelo otimo ajustado 2,fig.align='center',fig.height=4.5,fig.width=6.5,cache = FALSE,echo=FALSE, warning = FALSE,eval=TRUE,message = FALSE}
#echo = FALSE não permite que o chunk apareça no pdf
